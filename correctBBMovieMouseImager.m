...
for ii = 1:nFiles
    ...
    tempMovieDataProjSub = bsxfun(@minus,tempMovieData,dataBlankImage);
    ...
    tempWriteName = [tempMovieName(1:end-3) ' Movie - Blank + NUC.h5'];
    tempWriteFullName = fullfile(oldPath,tempWriteName);

    h5create(tempWriteFullName,'/Image/Data',[tempDim1 tempDim2 tempNumFrames],'Datatype','double');
